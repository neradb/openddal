...
public class JdbcQueryWorker extends JdbcWorker implements QueryWorker {
    ...
    public Cursor executeQuery() {
        try {
            ...
            return new ResultCursor(session, new AutoCloseResultSet(opendResultSet, this));
        } catch (Exception e) {
            close();
    ...
    private static class AutoCloseResultSet implements ResultSet {
        private final ResultSet resultSet;
        private final JdbcQueryWorker worker;

        private AutoCloseResultSet(ResultSet resultSet, JdbcQueryWorker worker) {
